...
namespace API_QuanLyNhaThuoc
{
    public partial class FrmImportDetailProduct : Form
    {
        ...
        public FrmImportDetailProduct(string id)
        {
            InitializeComponent();
        ...
        {
            dgvComboBox.ValueMember = "RoleCode";
            dgvComboBox.DisplayMember = "RoleName";
            dgvComboBox.DataSource = Category_DAO.Instance.GetListCategoryProduct("");
        }
