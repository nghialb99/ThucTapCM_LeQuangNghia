...
namespace API_QuanLyNhaThuoc
{
    public partial class FrmCategoryProduct : Form
    {
        ...
        {
            dgvCategory.DataSource = Category_DAO.Instance.GetListCategoryProduct("");
        ...
        private void dgvRoleUser_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                ...
                if(Convert.ToBoolean(dgvCategory.Rows[i].Cells[5].Value))
                {
                    btRestore.Enabled = false;
                    btLock.Enabled = true;
                }
        ...
        private void btSave_Click(object sender, EventArgs e)
        {
            ...
            if (tbRoleCode.Enabled == true)
            {
                ...
                {
                    if (Category_DAO.Instance.InsertCategoryProd(roleName,tbRoleName.Text.Trim(),tbNote.Text))
                    {
                        LoadData();
                        btNew.Enabled = true;
            ...
            {
                if (Category_DAO.Instance.UpdateCategoryProd(roleName, tbRoleName.Text.Trim(), tbNote.Text))
                {
                    LoadData();
                    btEdit.Enabled = true;
                    btNew.Enabled = true;
        ...
        private void btLock_Click(object sender, EventArgs e)
        {
            ...
            {
                if (Category_DAO.Instance.LockCategoryProd(tbRoleCode.Text))
        ...
        {
            if (Category_DAO.Instance.UnLockCategoryProd(tbRoleCode.Text))
        ...
        {
            dgvCategory.DataSource = Category_DAO.Instance.GetListCategoryProduct(tbSearch.text);
            SetColorRowWhenBillStatusIsDelete();
        }
